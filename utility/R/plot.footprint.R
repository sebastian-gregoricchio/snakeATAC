#' @title plot.footprint
#'
#' @description
#' Replotting of footprints starting from \href{https://deeptools.readthedocs.io/en/develop/}{deeptools} matrices. It allows for the filter over a specific region set (white list).
#'
#'
#' @param matrix.gz Path to a motif matrix generated by snakeATAC. Usually it can be find at \code{./05b_Differential_TF_binding_TOBIAS/D_density_profiles_merged_BAMs/matrices/MOTIF.ID_single.base.scores_per.region.gz}.
